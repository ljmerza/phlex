<?php
    ...
    /**
     * update an array of user settings
     */
    ...
    /**
     * convert string boolean into boolean if matches certain fields
     */
    ...
    /**
     * create a config file if it doesnt eixst
     */
    function initConfig() {
        ...
        // if we have no config file t hen create it
        if (!$config) {
    ...
    /**
     * set a preference after making sure the init config exists
     */
    ...
    /**
     * get a preference after making sure the init config exists
     */
    ...
    /**
     * delete a preference after making sure the init config exists
     */
    ...
    /**
     * checks if user settings exist if they do they load them
     * else create defaults. Return the user settings.
     */
    function checkDefaults() {
        $config = dirname(__FILE__) . "/../rw/db.conf.php";

        // see if the db file exsit if it does then use that db config
        $useDb = file_exists($config);
        if ($useDb) {
            checkDefaultsDb($config);
        }

        // load the general settings if found
        ...
        if ($defaults) {
            ...
            // else we need to create a new config file
            $defaults = [
